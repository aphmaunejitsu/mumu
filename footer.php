...
<footer id="main-footer">
	<div class="container flex flex-column justify-center">
		...
		if ( $tw_url ) :
			?>
			<a href="<?php esc_url( $tw_url ); ?>" target="_blank" class="inline-block p1" aria-label="<?php echo bloginfo( 'name' ); ?> Twitter">
		...
		if ( $fb_url ) :
			?>
			<a href="<?php esc_url( $fb_url ); ?>" target="_blank" class="inline-block p1" aria-label="Link to <?php echo bloginfo( 'name' ); ?> Facebook">
