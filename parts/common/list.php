...
<?php if ( is_search() ) :
	...
	<section class="sgn-category-title center">
		<h2><i class="fas fa-search"></i> <?php echo $search_query; ?></h2>
	</section>
<?php elseif ( is_archive() ) : ?>
	<section class="sgn-category-title center">
		<h2><i class="fas fa-tags"></i> <?php esc_html( single_cat_title() ); ?></h2>
	</section>
<?php endif; ?>
<div class="sgn-list">
<?php
	...
	while ( have_posts() ) :
		...
		<a href="<?php echo get_the_permalink(); ?>" class="mb1 text-decoration-none" >
					<div class='card overflow-hidden relative'>
						...
						<div class="post-category nowrap absolute display-inline"><i class="fas fa-tags"></i> <?php echo esc_attr( $category ); ?></div>
						<h3 class="post-title mb1 px1"><?php echo $title; ?></h3>
						<div class="post-time px1">
							<time datetime="<?php echo $date; ?>" class="mr1"><i class="fas fa-calendar-alt fa-fw"></i> <?php echo $date; ?></time>
							<time datetime="<?php echo $mdate; ?>"><i class="fas fa-sync-alt fa-fw"></i> <?php echo $mdate; ?></time>
						</div>
